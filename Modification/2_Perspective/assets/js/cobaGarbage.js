...
// Transform controls
// Transform controls
var rotationTheta = [30, 30, 0]; // Renamed to avoid conflict
var translation = [0, 0, 0]; // Use vec3 for translation
...
//
var near = 0.3;
var far = 10.0; // Increased far plane for better visibility
var radius = 4.0;
var cameraTheta = 0.0; // Renamed to avoid conflict
var cameraPhi = 0.0; // Renamed for clarity
...
function render() {
    ...
    var modelMatrix = mat4(); // Start with identity matrix
    modelMatrix = mult(modelMatrix, translate(translation[0], translation[1], translation[2]));
    ...
    // 4. Set up the projection matrix
    projectionMatrix = perspective(fovy, aspect, near, far);

    // 5. Send matrices to the shader
